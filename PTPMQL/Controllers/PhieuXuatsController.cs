...
namespace PTPMQL.Controllers
{
    public class PhieuXuatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDHoaDon,IDHang,DonGia,SoLuongBan")] PhieuXuat phieuXuat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDHoaDon,IDHang,DonGia,SoLuongBan")] PhieuXuat phieuXuat)
        {
            if (ModelState.IsValid)
            {
